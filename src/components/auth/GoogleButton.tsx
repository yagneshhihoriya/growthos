  ...
  return (
    <button
      ...
      className={cn(
        ...
        isDark
          ? "border border-white/[0.08] bg-white/[0.04] text-neutral-200 hover:border-white/15 hover:bg-white/[0.07]"
          : isLight
            ? "border border-gray-200 bg-white text-gray-900 shadow-sm hover:border-gray-300 hover:bg-gray-50/80 hover:shadow-md"
            : "border border-border-default bg-bg-elevated/90 text-text-primary shadow-sm hover:border-border-strong hover:bg-bg-overlay"
      )}
    >
